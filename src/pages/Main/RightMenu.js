    ...
    return (
        <div className="main-right">
            <div className="my-area">
                <img className="profile-img-l" id="mine" src="/images/profile-img.png"/>
            ...
            <div className="story-area">
                ...
                <div className="story-set">
                    <img className="profile-img-m" id="" src="/images/profile-img4.png"/>
                    <div className="story-info" id="story-01">
                        <span className="ids">chuihae</span>
                        <div className="story-time">
                            <span className="time" id="stored-time">stored-time</span>
                            <span className="time-min">분 전</span>
                        </div>
                    </div>
                </div>
                <div className="story-set">
                    <img className="profile-img-m" id="" src="/images/profile-img6.png"/>
                    <div className="story-info" id="story-01">
            ...
            <div className="recommendation-area">
                ...
                <div className="recommend-set">
                    <img className="profile-img-m" id="" src="/images/profile-img3.png"/>
                    <div className="recommend-info" id="recommend-01">
                        <span className="ids">joonim</span>
                        <div className="followed-people">
                            <span className="ids" id="recommend-id-01">2chagogo</span>
                ...
                <div className="recommend-set">
                    <img className="profile-img-m" id="" src="/images/profile-img7.png"/>
                    <div className="recommend-info" id="recommend-01">
                        <span className="ids">1000goock</span>
                        <div className="followed-people">
                            <span className="ids" id="recommend-id-01">joomo</span>
                            <span className="sir">님 외</span>
                            <span className="number-of-people">n</span>
                            <span className="followed-text">명이 팔로우했습니다</span>
                        </div>
